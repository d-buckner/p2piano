...
export function PlayIcon(props: IconProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" class={props.class}>
...
export function MusicIcon(props: IconProps) {
  const size = props.size || 16;
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class={props.class}>
